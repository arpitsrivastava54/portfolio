export const profile = {
  ...
  moniker: '// Arpit.S',
  title: 'Full Stack Engineer | AI & GenAI',
  tagline: 'Full Stack Engineer\n& AI Systems',
  headline:
    'Building production AI platforms that scale. Specialized in LLMs, real-time systems, and high-performance backend architecture.',
  email: 'arpitsrivastava54@gmail.com',
  ...
  footerNote: 'Built with Next.js, Framer Motion & LLMs.',
  githubUsername: 'arpitsrivastava54',
};

export const globalMetrics = [
  { end: 5000, label: 'Users Served Across Platforms', suffix: '+' },
  { end: 95, label: 'AI Accuracy Achieved', suffix: '%+' },
  { end: 6, label: 'Production Platforms Shipped' },
];
