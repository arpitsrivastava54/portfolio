...
const sidebarItems = [
  {
    name: 'Home',
    link: '/',
    icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-home "><path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg>
  },
  {
    name: 'Internship',
    link: '#internship',
    icon: <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 text-green-600">
...
const socialItems = [
  {
    name: 'Github',
    link: 'https://www.github.com/arpitsrivastava54',
    icon: <svg className="w-6 h-6 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
  ...
  {
    name: 'LinkedIn',
    link: 'https://www.linkedin.com/in/arpit-srivastava-b4788027a/',
    icon: <svg className="w-6 h-6 text-blue-800" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
...
const ResponsiveSidebar = ({showSidebar,setShowSidebar}:Props) => {
  return (
    <section className={`bg-secondry p-2 text-primary h-screen ${showSidebar ? "show-sidebar":"hide-sidebar"}`} >
      ...
      <h2 className='my-5'>Social Links</h2>
