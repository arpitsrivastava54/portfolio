...
const Experience = () => {
  return (
    <main className='my-10 me-5'>
      <h2 className='text-2xl text-zinc-200 my-10'>Experience</h2>
      <section className='bg-secondry w-full p-5 rounded-2xl'>
        <div className='flex justify-evenly'>
          ...
          <div className="content w-[85%]">
            <h2 className='text-xl text-zinc-100'>React Developer</h2>
            <p className='text-sm text-zinc-200'>CareerBanao <span> . </span>Internship</p>
            ...
            <p className='text-zinc-300 text-sm'>
              <span className='text-zinc-50 text-base'>Skills : </span>
        ...
        <div className="websites w-full my-5 flex justify-evenly">
          {/* first websites */}
          <div className='w-1/5'>
            <div className="exp-card w-full relative bg-white rounded-xl">
              ...
              <div className='exp-overlay justify-center items-center hidden w-full bg-black absolute top-0 hover:rounded-md z-55'>
                <a href="#" className='border font-bold px-5 py-2 rounded-3xl'>Visit site</a>
              </div>
            </div>
