...
import cbProfileImg from "../assets/cb-profile.jpg"
      ...
      <section className='bg-secondry w-full p-3 lg:p-5 rounded-2xl'>
        <div className='flex justify-evenly'>
          <div className="company-logo w-[10%] rounded-full justify-between ">
            <Image src={cbProfileImg} alt="" className='w-full rounded-full transform scale-75' />
          </div>
        ...
        <div className="websites w-full my-5 flex gap-3 justify-evenly">
          ...
          <p className='text-xs my-2 text-zinc-400 text-center'>Main Website</p>
            <div className="exp-card w-full relative bg-white rounded-xl">
              ...
              <div className='exp-overlay justify-center items-center hidden w-full bg-black absolute top-0 hover:rounded-md z-55'>
                <a href="https://careerbanao.org/" target='_blank' className='border font-bold text-xs p-2 lg:px-5 lg:py-2 rounded-3xl'>Visit site</a>
              </div>
            </div>
          ...
          <p className='text-xs my-2 text-zinc-400 text-center'>CB Store Website</p>
            <div className="exp-card w-full relative bg-white rounded-xl">
              ...
              <div className='exp-overlay justify-center items-center hidden w-full bg-black absolute top-0 hover:rounded-md z-55'>
                <a href="https://cbstore.careerbanao.org/" target='_blank' className='border font-bold text-xs p-2 lg:px-5 lg:py-2 rounded-3xl'>Visit site</a>
              </div>
            </div>
            <p className='text-xs my-2 text-zinc-400 text-center'>Contribution in all pages</p>
          </div>
          ...
          {/* third websites  */}
          <div className='w-1/3 lg:w-1/5'>
          <p className='text-xs my-2 text-zinc-400 text-center'>Admin Pannel</p>
            <div className="exp-card w-full relative bg-white rounded-xl">
